...
namespace Muresan_Edmond_Ferenc_Lab2.Models
{
    ...
    { 
        ...
        // [RegularExpression(@"^([0]{1})[-. ]?([0-9]{3})[-. ]?([0-9]{3})[-. ]?([0-9]{3})$", ErrorMessage =
        //  "Telefonul trebuie sa fie de forma '0722-123-123' sau '0722.123.123' sau '0722 123 123'")]
        [RegularExpression(@"^0\d{9}$", ErrorMessage = "Numărul de telefon trebuie să înceapă cu 0 și să conțină încă 9 cifre.")]
